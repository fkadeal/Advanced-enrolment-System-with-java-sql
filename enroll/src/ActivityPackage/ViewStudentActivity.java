...
public class ViewStudentActivity extends JFrame implements ActionListener {
	...
	public ViewStudentActivity(JFrame prev, Staff Staff) {
		super("View Student");
		...
		model.setColumnIdentifiers(Student.columnName);
		...
		table.setModel(Student.searchStudent("", "By Name"));
	...
	public void actionPerformed(ActionEvent ae) {
		if (ae.getSource().equals(buttonLogout)) {
			...
			table.setModel(Student.searchStudent(keywordTF.getText().trim(), byWhatCB.getSelectedItem().toString()));
		}
		else {}
	}
	...
	private void jTable_ClickMouseClicked(MouseEvent evt) {                                          
	   ...
	   new ManageStudent(value1, this).setVisible(true);
    }
}