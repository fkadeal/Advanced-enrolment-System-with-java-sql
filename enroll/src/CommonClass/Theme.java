...
public class Theme {
	...
	public static final Color BACKGROUND_PANEL = new Color(196, 255, 77);
	public static final Color BACKGROUND_HEADER = new Color(102, 153, 0);
	...
	public static final Color BACKGROUND_BUTTON_PRIMARY = new Color(102, 153, 0);
	
	public static final Font FONT_TITLE = new Font(Font.SANS_SERIF, Font.BOLD, 30);
